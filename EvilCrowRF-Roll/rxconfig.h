...
<FORM action="/setrx" method="post" id="config" target="iframe">
    ...
    <hr>
    <p>Frequency Jammer: </p><textarea class="css-input-text" form="config" rows="1" cols="50" name="frequency_jammer"></textarea>
    <hr>
    <p>Power Jammer: </p><textarea class="css-input-text" form="config" rows="1" cols="50" name="power_jammer"></textarea>
    <hr>
